...
"x86_64-linux-2.6.32-573.7.1.el6.x86_64" or
	die "Errno architecture (x86_64-linux-2.6.32-573.7.1.el6.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
